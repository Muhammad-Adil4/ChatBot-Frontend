...
import { loginUser, signUp, type AuthResponse } from "../api/Axios";
...
const Login = () => {
  ...
  const mutation = useMutation<AuthResponse, AxiosError, LoginSchemaType>({
    mutationFn: (data) => (isSignUp ? signUp(data) : loginUser(data)),
    onSuccess: (data) => {
      toast.success(isSignUp ? "Signup successful!" : "Login successful!");
      console.log(isSignUp ? "Signup success:" : "Login success:", data);
      // TODO: Store user in Redux or localStorage
    },
    onError: (error) => {

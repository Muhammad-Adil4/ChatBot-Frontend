...
export default function TrustedCompanies() {
    return (
        <section className="flex flex-col items-center">
            ...
            />
            <motion.div 
                className="relative max-w-5xl py-20 md:py-26 mt-18 md:w-full overflow-hidden mx-2 md:mx-auto border border-indigo-900 flex flex-col md:flex-row items-center justify-between bg-linear-to-br from-[#401B98]/5 to-[#180027]/10 rounded-3xl p-4 md:p-10 text-white"
            ...
            >
                ...
                <div className="absolute pointer-events-none top-10 -z-10 left-20 w-64 h-64 bg-linear-to-br from-[#536DFF] to-[#4F39F6]/60 blur-[180px]"></div>
                <div className="absolute pointer-events-none bottom-10 -z-10 right-20 w-64 h-64 bg-linear-to-br from-[#536DFF] to-[#4F39F6]/60 blur-[180px]"></div>
                ...
                <div className="flex flex-col items-center md:items-start max-md:text-center">
                    ...
                    >
                        ...
                        <p className="flex items-center gap-1">
                            ...
                            <svg 
                                ...
                                className="lucide lucide-chevron-right-icon group-hover:translate-x-0.5 transition duration-300"
                            >
                    ...
                    <h1 className="text-3xl font-medium max-w-xl mt-5 bg-linear-to-r from-white to-[#b6abff] text-transparent bg-clip-text">
